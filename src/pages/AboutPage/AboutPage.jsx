...
export default function AboutPage() {
  const members = [
    ...
    {
      name: "Trần Sỹ Huy",
      linkedin: "https://www.linkedin.com/in/kerry0805/",
      github: "https://github.com/kerry0805",
      avatar:
        "https://res.cloudinary.com/davzqwcoq/image/upload/v1753467196/mlscutvpd41kgp9ddm2v.jpg",
      description:
        "A student at FPT University, majoring in SE. Get your priority straight and do something else than staring at me. I'm not that handsome.",
      role: "",
    },
    {
      name: "Vũ Quốc Hoàng",
    ...
    <div className="about-page-container container-fluid text-white">
      <div className="row">
        ...
        <div className="main-content col-lg-10">
          ...
          <div className="mb-4">
            Welcome to our website. This platform was created as part of an
            educational project, developed by a passionate team of students with
            a shared interest in software engineering and web development.
          </div>

          <p>
            Our goal is to deliver a practical, responsive, and aesthetically
            pleasing experience for users while sharpening our technical and
            teamwork skills.
          </p>

          <p>
            This site serves as both a learning playground and a showcase of
            what young developers can achieve through collaboration and
            determination.
          </p>

          <p>
            We strongly believe in learning by doing, and this project reflects
            our hands-on approach to applying what we've studied in real-world
            scenarios.
          </p>

          <h2>Meet Our Team</h2>
          <p>
            We are a group of enthusiastic developers dedicated to building
            user-friendly and functional web applications. Here's a brief
