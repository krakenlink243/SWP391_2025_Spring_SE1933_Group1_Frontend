...
function ChatBodyRight({
    ...
    const handleSend = () => {
        if (!curChat || !input.trim() || isBanned) return;
                            ...
                            <div className={`padder-top-content h-100 d-flex align-items-center justify-content-between gap-3 p-2 ${curChat.type === 'group' ? 'show' : ''}`}>
                                ...
                                <div className="user-actions d-flex flex-row align-items-center gap-2">
                                    <div className="setting-icon" onClick={() => setAddMemberPopup(true)}>
                                        <svg version="1.1" id="Layer_5" xmlns="http://www.w3.org/2000/svg" className="h-100 w-100" x="0px" y="0px" width="256px" height="255.999px" viewBox="0 0 256 255.999"><path d="M165.678,20.535c-17.251,0-31.386,14.135-31.386,31.386c0,17.252,14.135,31.386,31.386,31.386 c17.251,0,31.386-14.134,31.386-31.386C197.063,34.67,182.929,20.535,165.678,20.535z"></path><path d="M165.678,93.121c24.995,0,45.335,20.34,45.335,45.335v52.31c0,3.853-3.123,6.975-6.975,6.975h-13.95v34.874 c0,3.852-3.123,6.974-6.974,6.975h-34.874c-3.852-0.001-6.974-3.123-6.975-6.975v-34.874h-13.95c-3.852,0-6.974-3.123-6.974-6.975 v-52.31C120.343,113.461,140.683,93.121,165.678,93.121z"></path><g className="invitePlus"><line fill="none" stroke="#ffffff" strokeWidth="22" strokeMiterlimit="10" x1="14" y1="128" x2="101.5" y2="128"></line><line fill="none" stroke="#ffffff" strokeWidth="22" strokeMiterlimit="10" x1="57.75" y1="84.25" x2="57.75" y2="171.75"></line></g></svg>
                                    </div>
