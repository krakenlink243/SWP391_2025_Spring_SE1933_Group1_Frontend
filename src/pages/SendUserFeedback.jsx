...
function SendUserFeedback() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${import.meta.env.VITE_API_URL}/request/feedback/send`, {
                ...formData, mediaUrls: responseMedia?.data?.imageUrls || []
            });
    ...
    return (
        <div className='sendfeedback-container'>
            ...
            <div className='feedback-button'>
                ...
                <Button label="Cancel" color='grey-button' onClick={() => navigate("/feedbackhub")} />
            </div>
        </div>
    )
}
